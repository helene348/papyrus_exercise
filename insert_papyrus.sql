...
insert into "PRODUIT" ("CODART","LIBART","STKALE","STKPHY","QTEANN","UNIMES") values ('I108','Papier 3ex Continu',200,557,3500,'B500');
insert into "PRODUIT" ("LIBART","CODART","STKALE","STKPHY","QTEANN","UNIMES") values ('I110', 'Papier 4ex Continu',10,12,63,'B400');
insert into "PRODUIT" values ('P220','Pré imprimé commande', 500, 2500, 24500,'B500');
insert into "PRODUIT" values ('P230','Pré imprimé facture', 500, 250, 12500,'B1000');
...
insert into "PRODUIT" values ('B002','Bande magnétique 6250', 20, 12, 410,'unité');
insert into "PRODUIT" values ('B001','Bande magnétique 1200', 20, 87, 240,'unité');
...
insert into "ENTCOM" values (70020, NULL,'25/04/2007', 00180);
...
insert into "ENTCOM" values (70300, NULL, '06/06/2007', 00120);
